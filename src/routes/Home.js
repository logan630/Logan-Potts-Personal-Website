        ...
        <div className="homePage">
            <div className="row">
                <div className="aboutMe">
                    ...
                    <p>I graduated from Stevens Institute of Technology in May 2024 with a <span className="emphasis">Bachelors of Science in Computer Science</span> with a concentration in <span className="emphasis">Machine Learning</span> and a minor in <span className="emphasis">Pure and Applied Mathematics</span>.</p>
